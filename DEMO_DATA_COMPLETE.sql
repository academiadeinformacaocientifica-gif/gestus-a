-- ============================================================
-- INSERÇÃO DE DADOS DE TESTE - CONTA DEMO
-- ============================================================
-- 
-- Email: Demo@demo.com
-- Senha: demo1234
...
-- 3. Substitua 'REPLACE_WITH_USER_ID' pelo UUID
-- 4. Execute este SQL no SQL Editor
-- ============================================================

-- PASSO 1: CRIAR PERFIL
-- Descomente e execute primeiro se o perfil não foi criado automaticamente
-- INSERT INTO public.profiles (user_id, nome, nome_negocio)
-- VALUES ('REPLACE_WITH_USER_ID', 'Demo', 'Somiles - Retalhista');

-- ============================================================
-- PASSO 2: INSERIR PRODUTOS (STOCK) - 44 PRODUTOS
-- ============================================================
...
-- ============================================================
-- PASSO 3: INSERIR TRANSAÇÕES (DESPESAS) - 30 REGISTOS
-- ============================================================
...
-- ============================================================
-- PASSO 4: INSERIR VENDAS (GANHOS) - 40 REGISTOS
-- ============================================================
...
-- ============================================================
-- 
-- Se chegou até aqui e não teve erros, os dados foram inseridos!
-- 
-- Agora pode fazer login com:
-- Email: Demo@demo.com
-- Senha: demo1234
-- 
-- E ver todos os dados na aplicação:
-- - 44 produtos no Stock
-- - 30 transações (despesas)
-- - 40 vendas
-- 
-- Dados de 3 meses (Dec 2025 - Mar 2026)
-- ============================================================
